...
export function inputStyle(theme, isTextInput = true) {
    return Object.assign(Object.assign({ backgroundColor: theme.inputs.text.backgroundColor, borderWidth: theme.inputs.text.borderWidth, borderColor: theme.inputs.text.borderColor, borderRadius: theme.inputs.text.borderRadius, fontSize: theme.inputs.text.fontSize, color: theme.inputs.text.textColor, paddingHorizontal: theme.inputs.text.paddingHorizontal }, Platform.select({
        android: {
