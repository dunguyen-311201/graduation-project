...
const Touchable = styled.TouchableOpacity(({ theme }) => (Object.assign({}, inputStyle(theme, false))));
const WebInput = styled('input')(({ theme }) => (Object.assign({}, inputStyle(theme))));
...
const DateType = ({ onChange, arg: { name, value } }) => {
    ...
    if (Platform.OS === 'web') {
        return (React.createElement(View, { testID: name },
            React.createElement(WebInput, { type: "datetime-local", value: webDateString, onChange: (e) => onChange(new Date(e.target.value)) })));
    }
    return (React.createElement(View, { testID: name },
