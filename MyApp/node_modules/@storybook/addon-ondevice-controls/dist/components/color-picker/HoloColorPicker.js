...
import { Text, TouchableOpacity, View, Image, StyleSheet, InteractionManager, I18nManager, } from 'react-native';
...
export class HoloColorPicker extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(View, { style: style },
            React.createElement(View, { onLayout: this._onLayout, ref: this.pickerContainer, style: styles.pickerContainer }, !pickerSize ? null : (React.createElement(View, null,
                React.createElement(View, Object.assign({}, this._pickerResponder.panHandlers, { style: [styles.picker, computed.picker], collapsable: false }),
                    React.createElement(Image, { source: require('./resources/color-circle.png'), resizeMode: "contain", style: [styles.pickerImage] }),
                    React.createElement(View, { style: [styles.pickerIndicator, computed.pickerIndicator] })),
                oldColor && (React.createElement(TouchableOpacity, { style: [styles.selectedPreview, computed.selectedPreview], onPress: this._onColorSelected, activeOpacity: 0.7 })),
                oldColor && (React.createElement(TouchableOpacity, { style: [styles.originalPreview, computed.originalPreview], onPress: this._onOldColorSelected, activeOpacity: 0.7 })),
                !oldColor && (React.createElement(TouchableOpacity, { style: [styles.selectedFullPreview, computed.selectedFullPreview], onPress: this._onColorSelected, activeOpacity: 0.7 }))))),
            this.props.hideSliders ? null : (React.createElement(View, null,
                React.createElement(Text, { style: { paddingStart: 4, color: '#859499', fontSize: 12 } }, "Saturation"),
                React.createElement(Slider, { value: s, onValueChange: this._onSValueChange }),
                React.createElement(Text, { style: { paddingStart: 4, color: '#859499', fontSize: 12 } }, "Lightness"),
                React.createElement(Slider, { value: v, onValueChange: this._onVValueChange })))));
    }
}
